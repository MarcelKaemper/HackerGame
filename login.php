<?php
    ...
    function wrongData() {
        echo "<form id=\"login_form\" action\"index.php?page=login\" method=\"POST\">
                <input class=\"form_input box-style-input\" name=\"username\" type=\"text\" placeholder=\"Username\" required><br />
                <input class=\"form_input box-style-input\" name=\"password\" type=\"password\" placeholder=\"Password\" required><br />
